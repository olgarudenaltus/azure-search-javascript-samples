...
import Results from '../../components/ResultsTaxStore/ResultsTaxStore';
...
export default function TaxStore() {
  ...
  console.log("This is Tax Store Search Page");
  ...
  useEffect(() => {
    ...
    axios.post( `${apiBaseUrl || ""}/api/taxstore`, body)
      .then(response => {
