...
import Results from '../../components/ResultsTaxPenalty/ResultsTaxPenalty';
...
import "./TaxPenalty.css";

export default function TaxPenalty() {
  ...
  console.log("This is Tax Penalty Search Page");
  ...
  useEffect(() => {
    ...
    axios.post( `${apiBaseUrl || ""}/api/taxpenalty`, body)
      .then(response => {
