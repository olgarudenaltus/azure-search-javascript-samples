...
export default function Result(props) {
    ...
    <div class="card border-0 border-bottom">
        <div class='card-body'>
            ...
            <h5 title="Click to opean a file" style={{'overflow':'hidden','white-space':'nowrap'}} class="card-title"><a class = "text-decoration-none" href={props.document.metadata_spo_library_id=="b!YkZ53NE4-E-IQGsKWThfdNPDxichE6FOtE2_hwunD_KnkfD-Dh--QbgG1RLg5ES_"?"file://Y:"+props.document.metadata_spo_item_path.substr(props.document.metadata_spo_item_path.indexOf(":/")+1, props.document.metadata_spo_item_path.lastIndexOf("/")):"file://W:"+props.document.metadata_spo_item_path.substr(props.document.metadata_spo_item_path.indexOf(":/")+1, props.document.metadata_spo_item_path.lastIndexOf("/"))}>{props.document.metadata_spo_item_name}</a></h5>
            ...
            <div class="col-12">
                    <div class="d-flex justify-content-start">
                        ...
                        <span title="Click to navigate to a folder" class="text-muted mx-2"><a href={props.document.metadata_spo_library_id=="b!YkZ53NE4-E-IQGsKWThfdNPDxichE6FOtE2_hwunD_KnkfD-Dh--QbgG1RLg5ES_"?"file://Y:"+props.document.metadata_spo_item_path.substr(0, props.document.metadata_spo_item_path.lastIndexOf("/")).substr(props.document.metadata_spo_item_path.indexOf(":/")+1, props.document.metadata_spo_item_path.lastIndexOf("/")):"file://W:"+props.document.metadata_spo_item_path.substr(0, props.document.metadata_spo_item_path.lastIndexOf("/")).substr(props.document.metadata_spo_item_path.indexOf(":/")+1, props.document.metadata_spo_item_path.lastIndexOf("/"))}>
